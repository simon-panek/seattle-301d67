...
let newSum = (a, b, c, d) => a + b + c + d; //Added by Simon

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sum(1, 2, 3, 4));
console.log(newSum(1, 2, 3, 4)); //Added by Simon
...
let newObjectLit = () => ({ //Added by Simon
  key1: 'value1',
  key2: 'value2',
  key3: 'value3',
});
...
console.log(newObjectLit()); //Added by Simon
...
let newSumAndProduct = (a, b) => { //Added by Simon
  let sum = a + b;
  let product = a * b;
  return [sum, product];
}
...
console.log(newSumAndProduct(3, 9)); //Added by Simon
...
let newMessage = name => (`Hello, ${name}!`); //Added by Simon

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));
console.log(newMessage('Allie')); //Added by Simon
...
let newStudent = array => ({ //Added by Simon
  name: array[0],
  age: array[1],
  hometown: array[2],
})

let array = ['Joe', 'Schmoe', 100]; //Added by Simon

// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this code to break!
console.log(joe);
console.log(newStudent(array)); //Added by Simon
...
//      Simon - "This" in an arrow function is not the contextual "this" that is needed for a constructor function. "This" in an arrow function retains the value of the arrow function's enclosing functional scope.

// This assignment was frustrating. I spent an inordinate amount of time researching how I might be able to use an arrow function to replicate the abilities of a constructor all the while knowing that arrow functions are not capable of being used as a constructor. Maybe somewhere in this assignment it should be made clear that coming to that realization is the point and that a solution is not expected. - Simon
