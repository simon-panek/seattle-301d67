...
function displayPics(){
  ...
  // Surprisingly, the previous line of code did not throw an error in the console, but the linter did mark it as being undefined. That is because the variable was declared in the scope of the while loop and not within the scope of the function.
  console.log(viewed);
